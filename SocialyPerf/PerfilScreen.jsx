...
export default function PerfilScreen({
  ...
  // 4 Publicações (feed de imagens publicadas em 2 colunas)
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        ...
        {/* --- GRID DE 4 PUBLICAÇÕES EM 2 COLUNAS COM SCROLL --- */}
          ...
          {posts.map((post, index) => (
            <View key={post.id || index} style={styles.postCardWrapper}>
              <Pressable
                ...
                accessibilityLabel={`Publicação ${index + 1}`}
              >
                {post.image ? (
                  <Image
      ...
      {/* --- RODAPÉ COM RESPEITO AO SISTEMA ANDROID --- */}
